...
echo ""
echo "Release published: https://github.com/William12556/pi-netconfig/releases/tag/${TAG}"
echo ""
echo "Install on Pi:"
echo "  curl -fsSL https://github.com/William12556/pi-netconfig/releases/latest/download/install.sh -o install.sh"
